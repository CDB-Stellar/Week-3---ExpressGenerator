...
//How to get the token user, then find user based on id
let strategy = new JWTStrategy(jwtOptions, (jwt_payload, done) => {
  User.findById(jwt_payload.id) //find the user from the payload (database), and if it's found return the user
    .then(user => {
...
passport.use(strategy); //activating strategy
